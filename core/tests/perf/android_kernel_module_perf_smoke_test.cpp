...
constexpr double kHotPathBudgetPct = 8.0;
constexpr double kOverallBudgetPct = 12.0;
...
int main() {
  ...
  constexpr ProtectionTargetKind kComparedTarget = ProtectionTargetKind::kAndroidKernelModule;
  ...
  std::cout << std::fixed << std::setprecision(3) << "lane=android_kernel_module"
