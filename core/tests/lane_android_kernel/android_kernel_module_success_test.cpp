...
int main() {
  ...
  const std::string manifest =
      ...
      "\"vermagic_profile\":false,\"gki_kmi_profile\":true}\n";
  ...
  const std::vector<std::string> required_fragments{
      ...
      "\"kernel_compat_profile\": \"gki_kmi_profile\"",
      "\"gki_kmi_profile\": true",
